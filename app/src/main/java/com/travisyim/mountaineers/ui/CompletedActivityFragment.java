...
public class CompletedActivityFragment extends ListFragment implements OnTaskCompleted,
    ...
    private final String TAG = CompletedActivityFragment.class.getSimpleName() + ":";
    ...
    public static CompletedActivityFragment newInstance(int sectionNumber) {
        CompletedActivityFragment fragment = new CompletedActivityFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_completed_activity, container, false);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        // Check to see if the Completed Activity fragment is still updating results
    ...
    public void onParseTaskCompleted(List<ParseObject> resultList, ParseException e) {
        ...
        if (!mIsCanceled) {
            /* This method is called when the task of retrieving the full set of Completed activities is
             * complete */
            mActivityList.clear();
            ...
            if (e == null) {
                ...
                mActivityList.addAll(ActivityLoader.load
                        (resultList, mFavoritesList, mMember, ActivityLoader.ActivityType.COMPLETED));
    ...
    public void onTaskCompleted(int stage, AsyncTaskResult<Boolean> result) {
        ...
        if (!mIsCanceled) {
            ...
            else {  // If successful scraping user history, find these items on the backend
    ...
    /* This method resets the Completed Activity fragment in the event the user logs out and logs
     * right back in */
